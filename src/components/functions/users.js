...
export const readProof = async (id) => {
    return await axios.get(process.env.REACT_APP_API + '/user/proofs/'+id,
       
    );
};
export const proofSend = async (authtoken, id, order) => {
    return await axios.put(process.env.REACT_APP_API + '/user/proof/' + id,
        order,
        {
            headers: {
                authtoken,
...
export const readUserSingle = async (authtoken) => {
...
export const updateUserSingle = async (authtoken, user, id) => {
    return await axios.put(process.env.REACT_APP_API + '/user/profile',
        user, id,
        {
            headers: {
                authtoken,
